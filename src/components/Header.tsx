      ...
      <nav className="mx-auto max-w-7xl px-6 lg:px-8" aria-label="Top">
        <div className="flex w-full items-center justify-between py-6">
          ...
          <div className="ml-10 hidden space-x-4 lg:flex">
            <button className="border border-foreground/20 hover:border-foreground/40 bg-transparent hover:bg-foreground/5 px-6 py-2 rounded-xl font-medium transition-all duration-200 text-foreground">
              Sign in
            </button>
            <Button className="bg-black text-white font-semibold px-5 py-3 rounded-xl text-base hover:bg-gray-800 transition-all duration-300">
              Get Started
            </Button>
          </div>
