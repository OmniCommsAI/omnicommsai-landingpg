      ...
      <div className="w-full max-w-7xl flex flex-col items-center gap-20">
        ...
        <div className="w-full max-w-5xl p-4 flex flex-col items-center gap-2.5 relative">
          ...
          <div className="w-full relative z-10">
            ...
            <div className="absolute -inset-6 bg-gradient-to-r from-red-500 via-orange-500 via-purple-500 to-pink-500 rounded-3xl opacity-60 z-0"></div>
            
            {/* Main Dashboard Image */}
            <div className="w-full aspect-[1.6/1] relative overflow-hidden rounded-2xl z-10">
              {/* Gradient Border */}
              ...
              >
                <div style={{ position: 'absolute', borderRadius: 'inherit', top: 0, right: 0, bottom: 0, left: -75px }}>
                  <img 
                    ...
                    style={{ display: 'block', width: '245', height: '265', borderRadius: 'inherit', objectPosition: 'center', objectFit: 'cover' }}
                  />
                </div>
              </div>
