        ...
        <div className="flex flex-col items-center gap-24">
          ...
          <div className="relative flex items-center justify-center gap-5 w-full max-w-6xl">
            ...
            <div className="relative flex-1 min-w-[400px] max-w-[600px]">
              {/* Dark overlay top */}
              <div className="absolute inset-x-0 top-0 h-8 bg-[rgb(30,30,30)] mix-blend-saturation z-10"></div>
              ...
              {/* Dark overlay bottom */}
              <div className="absolute inset-x-0 bottom-0 h-8 bg-[rgb(30,30,30)] mix-blend-saturation z-10"></div>
            </div>
          </div>
